...
<div class="flex min-h-screen">
  ...
  <div class="flex-1 flex flex-col min-w-0">
    ...
    <main class="p-5">
      <div class="mb-4"><h1 class="text-2xl font-head font-bold text-navy">Propostas e apólices</h1><p class="text-sm text-slate-500">Vida, Previdência, Saúde e Residencial em uma única carteira.</p></div>
      ...
      <div class="bg-white border border-line rounded-xl overflow-hidden">
        ...
        @empty
          <tr><td colspan="7" class="py-10 text-center text-slate-500">Nenhuma proposta ou apólice cadastrada.</td></tr>
        @endforelse
        </tbody></table></div>
